...
import 'dart:convert';
import 'package:local_api/screens/prodscreen.dart';
...
class _CadastroprodutosState extends State<Cadastroprodutos> {
  ...
  _cadastrarproduto()async{
    String url = "http://10.32.50.190:3000/produtos";
  ...
  _deletarproduto(){
    ...
    http.delete(Uri.parse('http://10.32.50.190:3000/produtos/${nomeprod.text}'));
    nomeprod.text="";
